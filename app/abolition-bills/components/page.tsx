      ...
      <section className="bg-white py-16">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-lg max-w-none space-y-6">
            ...
            <p>
              An abolition bill does not leave any preborn humans unprotected by law, unlike many pro-life bills which include exceptions allowing for abortion; for instance, in the case of rape. Isaiah 10 says &ldquo;Woe to those who make iniquitous decrees&rdquo; which &ldquo;make the fatherless prey.&rdquo; There&apos;s no one more fatherless than the child conceived in rape. It&apos;s unacceptable to allow for the murder of a baby because of the crime of the father. On top of being iniquitous, allowances for abortion in certain scenarios undermines the whole case against abortion. If abortion is murder, it doesn&apos;t stop being murder because of the circumstances of the baby&apos;s fertilization. More info about the importance of allowing for no exceptions can be found on our <Link href="/what-we-believe/no-exceptions" className="text-red-700 underline hover:no-underline">No Exceptions</Link> page.
            </p>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 flex justify-between">
            ...
            <Link href="/abolition-bills" className="text-red-600 font-semibold hover:underline">
