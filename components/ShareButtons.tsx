...
export default function ShareButtons({
  ...
  const handleCopyLink = async () => {
    try {
      ...
      posthog.capture('content_shared', { platform: 'copy_link', content_title: title });
      setCopied(true);
    ...
    <div className="flex flex-col items-center gap-3">
      ...
      <div className="flex items-center gap-3">
        ...
        <a
          ...
          onClick={() => posthog.capture('content_shared', { platform: 'facebook', content_title: title })}
        >
        ...
        <a
          ...
          onClick={() => posthog.capture('content_shared', { platform: 'x', content_title: title })}
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a
          ...
          onClick={() => posthog.capture('content_shared', { platform: 'email', content_title: title })}
        >
